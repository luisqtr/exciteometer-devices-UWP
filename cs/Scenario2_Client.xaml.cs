...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario2_Client : Page
    {
        ...
        private async void CharacteristicReadButton_Click()
        {
            ...
            System.Diagnostics.Debug.WriteLine("Read from PMD:" + BitConverter.ToString(data));
        ...
        private string FormatValueByPresentation(IBuffer buffer, GattPresentationFormat format)
        {
            ...
            System.Diagnostics.Debug.WriteLine("Received Notification:" + BitConverter.ToString(data));
